...
export const normalizeBackgroundImageUrl = (rawUrl) => {
  ...
  try {
    ...
    if (googleDriveFileId) {
      // Use the thumbnail endpoint — the old uc?export=view URL is deprecated and unreliable
      return `https://drive.google.com/thumbnail?sz=w2000&id=${googleDriveFileId}`
    }
